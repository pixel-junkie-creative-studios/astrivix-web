...
export default function Services() {
  ...
  // Wheel Scroll Interceptor & Lenis Pause Controller
  useEffect(() => {
    const handleWheel = (e) => {
  ...
  return (
    <div 
      id="services" 
      ref={sectionRef}
      className="relative z-10 w-full bg-transparent min-h-screen flex flex-col justify-center items-center pt-20 md:pt-24 pb-12 overflow-hidden"
    >
      {/* Header section */}
