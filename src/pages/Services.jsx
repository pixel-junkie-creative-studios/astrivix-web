...
export default function Services() {
  ...
  // Measure scroll progress through the 500vh track
  ...
  useMotionValueEvent(scrollYProgress, "change", (latest) => {
    // Map 0 -> 1 linearly across the 9 service cards
    ...
    if (calculatedIndex !== activeIndex) {
      setDirection(calculatedIndex > activeIndex ? 1 : -1);
  ...
  return (
    // 500vh Tall Scroll Track: Locks section stuck to viewport until all 9 cards are flipped!
