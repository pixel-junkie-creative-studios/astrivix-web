...
export default function Services() {
  ...
  // Track native scroll progress through the 900vh track
  ...
  useMotionValueEvent(scrollYProgress, "change", (latest) => {
    // Map scroll progress (0 to 1) across 9 cards
  ...
  return (
    // 900vh Scroll Track: Native CSS Browser Hardware Pinning
    <div id="services" ref={containerRef} className="relative w-full h-[900vh] bg-transparent">
      
      {/* Sticky Viewport Stage: Stuck 100% frozen for all 9 cards */}
