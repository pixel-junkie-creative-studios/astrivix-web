      ...
      >
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-white/90 mb-8 sm:mb-12 max-w-md text-sm sm:text-base leading-relaxed font-medium">
            Partner with Astrivix to design and build high-performance web platforms, custom applications, and strategic brand systems. Share your project goals below.
          </p>
          ...
          <div className="flex flex-col gap-8">
            <div>
              ...
              >
                ...
                <span className="text-xs font-bold tracking-[0.15em] uppercase text-white">DISCUSS YOUR PROJECT ON WHATSAPP →</span>
              </a>
            </div>
          </div>
        </div>
