    ...
    <div className="pt-16 sm:pt-24 pb-24 md:pb-40 min-h-[75vh] flex flex-col justify-center px-4 sm:px-6">
      ...
      >
        ...
        <div className="flex flex-col justify-center">
          <h1 className="text-4xl sm:text-6xl font-black mb-4 sm:mb-6 tracking-tight text-white drop-shadow-md">
            Contact Us.
          </h1>
          ...
          <div className="flex flex-col gap-8">
            ...
            <div>
              <p className="text-[10px] tracking-widest uppercase text-white/80 font-bold mb-4">WhatsApp Direct</p>
              <a 
                href="https://wa.me/917736387794" 
                target="_blank" 
                rel="noreferrer"
                className="inline-flex items-center gap-3 glass-metallic hover:border-white/50 rounded-xl px-6 py-4 transition-all duration-200 shadow-2xl group active:scale-95"
              >
                ...
                <span className="text-xs font-bold tracking-[0.1em] uppercase text-white">Message on WhatsApp</span>
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="glass-metallic p-8 md:p-12 rounded-[2.5rem] border border-white/20 border-t-white/40 shadow-2xl relative overflow-hidden flex flex-col justify-center group gpu-layer">
          ...
          <form className="space-y-6 relative z-10" onSubmit={(e) => e.preventDefault()}>
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-2">
                <label className="text-[10px] tracking-widest uppercase text-white/80 font-bold ml-2">Name</label>
                <input 
                  type="text" 
            ...
            <div className="space-y-2">
              <label className="text-[10px] tracking-widest uppercase text-white/80 font-bold ml-2">Email</label>
              <input 
                type="email" 
                className="w-full bg-[#0d0d12] border border-white/20 rounded-xl px-4 py-3 text-sm text-white focus:border-white/50 focus:outline-none transition-all placeholder:text-white/30"
            ...
            <div className="space-y-2">
              <label className="text-[10px] tracking-widest uppercase text-white/80 font-bold ml-2">Message</label>
              <textarea 
                rows="4"
