        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center max-w-sm w-full px-8">
            ...
            <motion.div 
              ...
              className="w-24 h-24 rounded-full border border-white/10 mb-8 flex items-center justify-center bg-[#050508] overflow-hidden shadow-[0_0_30px_rgba(168,85,247,0.3)]"
            >
              <video 
