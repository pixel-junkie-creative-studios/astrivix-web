        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex justify-between items-center border-b border-white/10 pb-4">
              <span className="text-[10px] font-mono font-bold tracking-[0.3em] text-white/80 uppercase flex items-center gap-2">
            ...
            <div className="flex flex-col gap-3 my-auto py-6">
              {navItems.map((item, idx) => (
                <a
                  ...
                  href={item.link}
                  onClick={(e) => handleScroll(e, item.link, idx)}
                  className="text-3xl font-black tracking-tighter uppercase text-white hover:text-white/80 transition-colors text-left flex items-center justify-between"
                >
                  <span>{item.name}</span>
