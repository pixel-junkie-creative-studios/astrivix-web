  ...
  return (
    ...
    >
      <div ref={preLayersRef} className="sm-prelayers" aria-hidden="true">
        {(() => {
          const raw = colors && colors.length ? colors.slice(0, 4) : ['#0A0A10', '#12121A', '#050508'];
          let arr = [...raw];
          if (arr.length >= 3) {
        ...
        <div className="sm-logo" aria-label="Logo">
          {logoUrl && logoUrl.endsWith('.mp4') ? (
            <video 
              ...
              muted 
              playsInline 
              className="sm-logo-img hover:scale-110 transition-transform duration-300"
            />
          ) : (
            <img
              src={logoUrl || '/assets/astreivix_nav_bar.mp4'}
              alt="Astrivix Logo"
