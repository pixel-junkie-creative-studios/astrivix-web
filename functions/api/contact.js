export async function onRequestPost(context) {
  ...
  try {
    ...
    // 1. Try Resend if API Key provided in environment (Both Admin & Customer Emails)
    if (env.RESEND_API_KEY) {
      try {
        ...
        if (adminRes.ok && adminData.id) dispatched = true;
            ...
            html: `
              <div style="font-family: system-ui, -apple-system, sans-serif; max-width: 600px; margin: 0 auto; background: #050508; color: #ffffff; padding: 32px; border-radius: 16px; border: 1px solid rgba(255,255,255,0.1);">
                <div style="border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 20px; margin-bottom: 24px; text-align: center;">
                  <h1 style="margin: 0; font-size: 24px; letter-spacing: 2px; color: #ffffff; text-transform: uppercase;">ASTRIVIX CORP</h1>
                ...
                <p style="font-size: 14px; color: #a1a1aa; line-height: 1.6;">Thank you for contacting Astrivix Corp. We have logged your request under Reference ID <strong style="color: #38bdf8;">${inquiryRef}</strong>. Our direct team will review your requirements and reach out shortly.</p>
                ...
                <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); padding: 20px; border-radius: 12px; margin: 24px 0;">
                  <h3 style="margin: 0 0 12px 0; font-size: 13px; color: #94a3b8; text-transform: uppercase; letter-spacing: 1px;">Submission Summary</h3>
                ...
                <div style="text-align: center; margin: 32px 0 24px 0;">
                  ...
                  <a href="https://wa.me/919876543210?text=Hi%20Astrivix%20Team%20(Ref:%20${inquiryRef})" style="display: inline-block; background: #25D366; color: #ffffff; font-weight: 600; font-size: 14px; text-decoration: none; padding: 12px 24px; border-radius: 8px; margin: 6px;">
                    💬 WhatsApp Direct
                  </a>
